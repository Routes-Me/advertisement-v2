...
namespace AdvertisementService.Extensions
{
    public static class APIExtensions
    {
        ...
        public static List<GetPromotionDto> GetPromotionsContents(List<GetContentDto> contents, string url)
        {
            List<GetPromotionDto> promotions = new List<GetPromotionDto>();
        ...
        public static GetPromotionDto GetPromotionsContentById(GetContentDto content, string url)
        {
            GetPromotionDto promotion = new GetPromotionDto();
            ...
            {
                var result = response.Content;
                var promotionData = JsonConvert.DeserializeObject<GetResponseApi<GetPromotionDto>>(result);
